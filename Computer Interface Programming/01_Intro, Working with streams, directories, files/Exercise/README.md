...
## Exercise 1:
Create a program in JAVA with which you will create a file with unique name  (e.g., uniqueFile_TIMESTAMP.txt, where TIMESTAMP is the current timestamp)
and output the following for that file:
The name
The location
