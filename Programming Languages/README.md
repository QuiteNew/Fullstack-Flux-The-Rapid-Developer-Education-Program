...
•	Increase the modularity of software by making it extensible.
•	Implement abstract data types through the use of classes.
•	Use constructor functions to initialize objects. 
•	Perform method overloading. 
•	Use inheritance to build a class hierarchy. 
•	Apply polymorphism and abstract classes.


### Learning Objectives

•	Use complete programming constructs to write a software application.
•	Demonstrate understanding of abstraction, specification, refinement and implementation.
